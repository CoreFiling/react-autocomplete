...
/***/ function(module, exports, __webpack_require__) {
	...
	var Autocomplete = React.createClass({
	  ...
	  render: function render() {
	    ...
	    return React.createElement('div', { style: this.props.style, className: this.props.className }, React.createElement('label', { htmlFor: this.id, ref: 'label' }, this.props.labelText), React.createElement('input', _extends({}, this.props.inputProps, {
	      role: 'combobox',
